...
def dispatch_test(llm_output_json: Dict[str, Any], df: pd.DataFrame):
    ...
    try:
        ...
        if test_name in ["Two-Sample Independent t-test", "Mann-Whitney U Test"]:
            ...
            test_results = data_prep.run_anova(prepared_data) if test_name == "ANOVA" else data_prep.run_kruskal(prepared_data, params)
        ...
        return error_msg, {'result': 'Empty Values from exception'}
